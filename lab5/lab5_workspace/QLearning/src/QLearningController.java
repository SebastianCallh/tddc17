		...
		void performAction(int action) {
			...
			switch (action) {
				...
				case 3: middleEngine.setBursting(true);
						break;
				case 4: middleEngine.setBursting(true);
						leftEngine.setBursting(true);
						break;
				case 5: middleEngine.setBursting(true);
			...
			if (!paused) {
				...
				if (previous_state != null) {
					...
					if (prev_qval == null) {
						...
						double qsa    = prev_qval;
						double r      = previous_reward;
						double g      = GAMMA_DISCOUNT_FACTOR;
						double maxQsa = getMaxActionQValue(new_state);
						double qval   = qsa + a * (r + g * maxQsa - qsa);
